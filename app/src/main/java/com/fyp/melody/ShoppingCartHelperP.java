 ...
 */
public class ShoppingCartHelperP {

    public static final String PRODUCT_INDEX = "PRODUCT_INDEX";

    private static List<Product> catalog;
    private static Map<Product, ShoppingCartEntryP> cartMap = new HashMap<Product, ShoppingCartEntryP>();
    ...
    public static void setQuantity(Product product, int quantity) {
        ...
        ShoppingCartEntryP curEntry = cartMap.get(product);
        ...
        if(curEntry == null) {
            curEntry = new ShoppingCartEntryP(product, quantity);
